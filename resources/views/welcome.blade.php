                ...
                <div class="table table-borderless">
                    <table class="table table-borderless" id="user_table">
                        ...
                        <tr v-for="item in items">
                            ...
                            <td>
                            <a id="show-modal" @click="showModal=true; setVal(item.id, item.name, item.age, item.profession)"  class="btn btn-info btn-sm btn-sm"><span
                            class="glyphicon glyphicon-pencil"></span>
                            </a>
                            <a @click.prevent="deleteItem(item)" class="btn btn-danger btn-sm"><span
