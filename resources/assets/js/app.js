...
var app = new Vue({
  ...
  methods: {
    getVueItems: function getVueItems() {
      ...
      axios.get('http://localhost/laravel_vue/public/vueitems').then(function (response) {
    ...
    createItem: function createItem() {
      ...
      if (input['name'] == '' || input['age'] == '' || input['profession'] == '' ) {
        ...
        this.hasError = true;
        axios.post('http://localhost/laravel_vue/public/vueitems', input).then(function (response) {
    ...
    editItem: function(){
         ...
         var p_val_1 = document.getElementById('e_profession');
          ...
          axios.post('http://localhost/laravel_vue/public/edititems/' + i_val_1.value, {val_1: n_val_1.value, val_2: a_val_1.value,val_3: p_val_1.value })
            .then(response => {
              this.getVueItems();
    ...
    deleteItem: function deleteItem(item) {
      var _this = this;
      axios.post('http://localhost/laravel_vue/public/vueitems/' + item.id).then(function (response) {
        _this.getVueItems();
        _this.hasError = true, 
